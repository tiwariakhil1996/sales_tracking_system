...
namespace STS.DAL
{
    public class AddactivityRepository : BaseRepository
    {
        //Addactivity
        public async Task<TranStatus> Addactivity(AddactivityModel model)
        {
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                parameter.Add("@sales_id", model.sales_id);
                parameter.Add("@sales_id", model.sales_id);
                parameter.Add("@lat_long", model.lat_long);
                parameter.Add("@appointment_date", model.appointment_date);
        ...
        public async Task<List<AddactivityListModel>> AddactivityList()
        {
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                var result = await connection.QueryAsync<AddactivityListModel>("AddactivityList", commandType: CommandType.StoredProcedure);
